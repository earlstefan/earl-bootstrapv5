...
@else if $rfs-base-value-unit == rem {
  $rfs-base-value: math.div($rfs-base-value, $rfs-base-value * 0 + 1 / $rfs-rem-value);
}
...
@else if $rfs-breakpoint-unit-cache == rem or $rfs-breakpoint-unit-cache == "em" {
  $rfs-breakpoint: math.div($rfs-breakpoint, $rfs-breakpoint * 0 + 1 / $rfs-rem-value);
}
  ...
  @each $value in $values {
    ...
    @else {
      ...
      @else {
        ...
        $value: math.div($value, $value * 0 + if($unit == px, 1, 1 / $rfs-rem-value));
